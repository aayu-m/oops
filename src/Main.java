...
public class Main {
    public static void main(String[] args) {
        Shape s1 = new Circle(5.5, true, "purple");  // Upcast Circle to Shape
        ...
        Shape s3 = new Rectangle(1.0, 2.0, false, "red");   // Upcast
        System.out.println(s3);
        System.out.println(s3.getArea());
        System.out.println(s3.getPerimeter());
        System.out.println(s3.getColour());
        //System.out.println(s3.getHeight());
        // we cant use functions of inheritated class which are speciific to that
